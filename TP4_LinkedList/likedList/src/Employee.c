 ...
 */
int employee_imprimirEmployee(void* this)
{
	int retorno = -1;
	Employee* pElement = (Employee*)this;
	int auxId;
	char auxNombre[NOMBRE_LEN];
	int auxHoras;
	int auxSueldo;
	if(this != NULL &&
	   ...
	   !employee_getHorasTrabajadas(pElement,&auxHoras) &&
...
int employee_ordenarEmployee(LinkedList* pArrayListEmployee,int len)
{
																			  ...
																			  "5-Salir\nElija una opcion(1-5): ","\nOpcion invalida!",1,5,3))
	{
		...
		case 2:
			...
			{
				printf("\nSe ordeno por Nombre exitosamente!\n");
				flagOrdenar = 1;
			}
			break;
		case 3:
			...
			{
				printf("\nSe ordeno por Horas Trabajadas exitosamente!\n");
				flagOrdenar = 1;
			}
			break;
		case 4:
			...
			{
				printf("\nSe ordeno por Sueldos exitosamente!\n");
				flagOrdenar = 1;
			}
			break;
		default:
