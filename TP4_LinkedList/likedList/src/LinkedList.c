...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    void* pElementOfThis2 = NULL;
    if(this != NULL && this2 != NULL)
    {
    	returnAux = 1;
    	for(i=0;i<len2;i++)
    	{
    		pElementOfThis2 = ll_get(this2,i);
    		if(!ll_contains(this,pElementOfThis2))
    		{
    			returnAux = 0;
    			break;
    		}
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this != NULL && pFunc != NULL && (order == 0 || order == 1))
    {
    	do
    	{
    		...
    		for(i=0;i<len-1;i++)
    		{
				if((order == 0 && pFunc(ll_get(this,i),ll_get(this,i+1)) < 0) ||
					(order == 1 && pFunc(ll_get(this,i),ll_get(this,i+1)) > 0))
				{
					pAux = ll_get(this,i);
